...
type BlockHandler interface {
	/*
		...
		Close() error
	*/
	BlockNumber(ctx context.Context) (*dbp.HexUint, error)
	GetBlockByHash(ctx context.Context, hash utils.H256) (*dbresponses.Block, error)
	GetBlockByNumber(ctx context.Context, number utils.Uint256) (*dbresponses.Block, error)
	GetBlockTransactionCountByHash(ctx context.Context, hash utils.H256) (*dbp.HexUint, error)
	GetBlockTransactionCountByNumber(ctx context.Context, number utils.Uint256) (*dbp.HexUint, error)
	GetTransactionByHash(ctx context.Context, hash utils.H256) (*dbresponses.Transaction, error)
