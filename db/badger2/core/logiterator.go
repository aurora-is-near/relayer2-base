...
func startLogIterator(txn *ViewTxn, chainId uint64, from *dbtypes.LogKey, to *dbtypes.LogKey) *logIterator {
	lit := &logIterator{
		txn:      txn,
		chainId:  chainId,
		from:     from,
